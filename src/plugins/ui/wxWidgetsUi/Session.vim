...
silent only
cd ~/projects/mru/src/plugins/ui/wxWidgetsUi
...
372
normal! zo
let s:l = 355 - ((15 * winheight(0) + 23) / 47)
...
9
normal! zo
let s:l = 38 - ((27 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 23 - ((19 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
