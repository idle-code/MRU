...
silent only
cd ~/projects/mru/src/plugins/input/BoostInputPlugin
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 BoostInputPlugin.hpp
badd +0 BoostInputPlugin.cpp
args BoostInputPlugin.hpp
edit BoostInputPlugin.cpp
...
11
normal! 0
lcd ~/projects/mru/src/plugins/input/BoostInputPlugin
wincmd w
argglobal
