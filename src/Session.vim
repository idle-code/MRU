...
badd +26 MruCore.cpp
badd +1 glue.hpp
badd +142 glue_impl.hpp
badd +1 FileIterator.hpp
badd +1 FileIterator.cpp
badd +1 metatag/expression.hpp
badd +7 metatag/expression.cpp
badd +1 tests/metatag_test.cpp
badd +1 metatag/metatag.hpp
badd +1 metatag/metatag.cpp
badd +4 metatag/CMakeLists.txt
badd +5 plugins/tags/StandardTags/StandardTags.hpp
badd +12 plugins/tags/StandardTags/StandardTags.cpp
badd +6 plugins/TagPlugin.hpp
badd +1 patterns.hpp
badd +1 plugin_manager/plugin_manager.hpp
badd +98 plugin_manager/plugin_manager_impl.hpp
badd +7 plugins/tags/StandardTags/Ext.hpp
badd +16 plugins/tags/StandardTags/ExtTag.hpp
badd +23 plugins/tags/StandardTags/ExtTag.cpp
badd +16 plugins/tags/StandardTags/NameTag.hpp
badd +20 plugins/tags/StandardTags/NameTag.cpp
badd +16 plugins/tags/StandardTags/DirTag.hpp
badd +23 plugins/tags/StandardTags/DirTag.cpp
badd +19 plugins/tags/StandardTags/CountTag.hpp
badd +31 plugins/tags/StandardTags/CountTag.cpp
badd +27 plugins/tags/StandardTags/TextCaseTag.hpp
badd +37 plugins/tags/StandardTags/TextCaseTag.cpp
badd +2 types.hpp
args MruCore.hpp
edit MruCore.cpp
...
365
normal! zo
let s:l = 346 - ((23 * winheight(0) + 23) / 46)
...
12
normal! zo
let s:l = 70 - ((21 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
1
normal! 0
tabedit ~/projects/mru/src/metatag/expression.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
357
normal! zo
let s:l = 416 - ((40 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
416
...
wincmd w
argglobal
edit ~/projects/mru/src/metatag/expression.hpp
setlocal noautoindent
setlocal balloonexpr=
setlocal nobinary
setlocal bufhidden=
...
wincmd w
argglobal
edit ~/projects/mru/src/metatag/metatag.hpp
setlocal noautoindent
setlocal balloonexpr=
setlocal nobinary
setlocal bufhidden=
...
93
normal! zo
let s:l = 84 - ((19 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
6
normal! zo
let s:l = 68 - ((17 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
7
normal! zo
let s:l = 14 - ((8 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
11
normal! zo
let s:l = 153 - ((10 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
