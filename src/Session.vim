...
379
normal! zo
let s:l = 311 - ((18 * winheight(0) + 23) / 47)
...
13
normal! zo
let s:l = 76 - ((37 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
