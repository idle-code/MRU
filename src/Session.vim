...
badd +1 plugin_manager/tests/test_module1.cpp
...
badd +1 glue.hpp
badd +7 glue.cpp
badd +61 glue_impl.hpp
badd +1 file_iterator.hpp
badd +55 file_iterator.cpp
badd +0 metatag.hpp
badd +0 metatag.cpp
silent! argdel *
edit core.cpp
...
133
normal zo
let s:l = 251 - ((46 * winheight(0) + 24) / 48)
...
173
normal zo
let s:l = 97 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
wincmd w
argglobal
edit ~/projects/mru/src/patterns.hpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
80
normal zo
let s:l = 69 - ((41 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
let s:c = 111 - ((60 * winwidth(0) + 52) / 105)
if s:c > 0
  exe 'normal! 0' . s:c . 'lzs' . (111 - s:c) . 'l'
else
  normal! 0111l
endif
lcd ~/projects/mru/src
wincmd w
argglobal
edit ~/projects/mru/src/plugin_manager/dynamic_module.hpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
10
normal zo
let s:l = 21 - ((14 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
68
normal zo
let s:l = 36 - ((27 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
wincmd w
argglobal
edit ~/projects/mru/src/plugin_manager/dynamic_module_bsd.hpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
7
normal zo
let s:l = 24 - ((20 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
30
normal zo
let s:l = 17 - ((9 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
exe 'vert 2resize ' . ((&columns * 105 + 105) / 211)
exe 'vert 3resize ' . ((&columns * 105 + 105) / 211)
tabedit ~/projects/mru/src/plugin_manager/tests/load_test.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/projects/mru/src/plugin_manager/tests/test_module2.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
wincmd w
argglobal
edit ~/projects/mru/src/plugin_manager/tests/test_module1.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
wincmd w
argglobal
edit ~/projects/mru/src/plugin_manager/tests/test_module.hpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
