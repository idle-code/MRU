...
badd +260 plugin_manager/plugin_manager_impl.hpp
badd +14 plugin_manager/tests/load_test.cpp
...
badd +0 plugins/ui/TextUi/TextUi.cpp
badd +0 plugins/ui/TextUi/TextUi.hpp
silent! argdel *
...
301
normal zo
let s:l = 126 - ((29 * winheight(0) + 24) / 48)
...
132
normal zo
let s:l = 95 - ((41 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
68
normal zo
let s:l = 29 - ((1 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
154
normal zo
let s:l = 65 - ((46 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
7
normal zo
let s:l = 18 - ((14 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
