...
silent only
cd ~/projects/mru/src/metatag
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +92 expression.hpp
badd +398 expression.cpp
...
badd +7 ~/projects/mru/src/types.hpp
badd +1 ~/projects/mru/src/patterns.hpp
args expression.hpp
edit expression.cpp
...
exe 'vert 2resize ' . ((&columns * 106 + 105) / 211)
argglobal
...
398
normal! zo
let s:l = 141 - ((11 * winheight(0) + 24) / 49)
...
exe 'vert 2resize ' . ((&columns * 57 + 105) / 211)
argglobal
setlocal noautoindent
setlocal balloonexpr=
setlocal nobinary
...
68
normal! zo
let s:l = 50 - ((18 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
...
exe 'vert 1resize ' . ((&columns * 153 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 57 + 105) / 211)
tabedit ~/projects/mru/src/plugins/tag_plugin.hpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
11
normal! zo
let s:l = 100 - ((35 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
exe 'vert 1resize ' . ((&columns * 105 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 105 + 105) / 211)
tabedit ~/projects/mru/src/plugin_manager/plugin_manager.hpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
9
normal! zo
let s:l = 38 - ((1 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
98
normal! zo
let s:l = 85 - ((26 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
