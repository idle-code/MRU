...
silent only
cd ~/projects/mru/src/plugin_manager
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 plugin_manager.cpp
badd +0 plugin_manager.hpp
badd +0 plugin_manager_impl.hpp
badd +0 tests/load_test.cpp
badd +0 tests/test_module.hpp
badd +0 tests/test_module1.cpp
silent! argdel *
edit plugin_manager.hpp
...
129
normal! zo
let s:l = 93 - ((32 * winheight(0) + 24) / 49)
...
161
normal! zo
let s:l = 174 - ((14 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
174
...
5
normal! zo
let s:l = 54 - ((3 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
8
normal! zo
let s:l = 30 - ((26 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
